        ...
        <View style={[styles.heroCard, { backgroundColor: palette.surface, borderColor: palette.gray100 }]}>
          <View style={styles.heroRow}>
            <View style={styles.heroCopy}>
              <Text style={[styles.eyebrow, { color: palette.green }]}>Book borrowing overview</Text>
              ...
              <Text style={[styles.heroText, { color: palette.gray500 }]}>
                Review your book borrowing calendar, check overdue items, and settle penalties from one screen.
              </Text>
        ...
        <View style={[styles.layout, isWide && styles.layoutWide]}>
          <View style={styles.mainColumn}>
            <Card style={styles.calendarCard}>
              ...
              <View style={styles.selectedDayPanel}>
                ...
                {selectedDayDueCount ? (
                  ...
                  <Text style={[styles.emptyText, { color: palette.gray500 }]}>No book borrowings are due on this date.</Text>
                )}
              </View>
            ...
            <Card>
              <View style={styles.sectionHeader}>
                <View>
                  ...
                  <Text style={[styles.sectionTitle, { color: palette.gray800 }]}>Book borrowings due on {selectedDate.toLocaleDateString(undefined, { month: 'long', day: 'numeric' })}</Text>
                </View>
            ...
            <Card>
              <View style={styles.sectionHeader}>
                <View>
                  <Text style={[styles.sectionKicker, { color: palette.green }]}>Book Borrowings</Text>
                  <Text style={[styles.sectionTitle, { color: palette.gray800 }]}>All your book borrowing requests and returns</Text>
                </View>
              </View>
              ...
              {loading ? (
                ...
                <EmptyState icon="library-outline" message="No book borrowing history yet." />
              )}
            </Card>
          </View>
                    ...
                    <View key={payment._id} style={styles.paymentItem}>
                      <View style={styles.paymentLeft}>
                        ...
                        <Text style={[styles.paymentMeta, { color: palette.gray500 }]}>
                          {payment.borrowingId?.bookId?.title || 'Book borrowing'}
                        </Text>
                      </View>
          ...
          <Pressable style={[styles.modalCard, { backgroundColor: palette.surface, borderColor: palette.gray100 }]} onPress={() => null}>
            ...
            <View style={styles.modalHeader}>
              <View>
                ...
                <Text style={[styles.modalTitle, { color: palette.gray800 }]}>{paymentTarget?.bookId?.title || 'Book borrowing'}</Text>
              </View>
